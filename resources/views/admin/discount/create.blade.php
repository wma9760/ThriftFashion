                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-1 overflow-hidden">
                                <h5 class="font-size-16 mb-1">Add Discount</h5>
                        ...
                        <form method="post" action="{{route('discount.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input id="productname" name="discount_percent" type="text" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" required>
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
