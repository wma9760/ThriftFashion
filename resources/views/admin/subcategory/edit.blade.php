                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-1 overflow-hidden">
                                <h5 class="font-size-16 mb-1">Edit SubCategory</h5>
                    ...
                    <div class="p-4 border-top">
                        <form method="post" action="{{route('subcategory.update',$subcategory->id)}}"  enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="productname" name="subcategory_name" type="text" value="{{$subcategory->subcategory_name}}" class="form-control @error('name') is-invalid @enderror" required>
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
