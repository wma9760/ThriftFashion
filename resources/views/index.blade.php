                        ...
                        <div class="col-xl-6 col-sm-4">
                            <div class="product-box">
                                ...
                                <div class="buttons m-3 text-center" >
                                     <button class="btn btn-success"><a href="{{route('product.edit',$product->id)}}" style="color:white">Edit</a></button>
                                     <button class="btn btn-danger"><a href="{{route('product.delete',$product->id)}}" style="color:white">Delete</a></button>
                                     @if($product->status==1)
                                        <button class="btn btn-dark"><a href="{{route('product.status',$product->id)}}" style="color:white">Deactivate</a></button>
                                     @else
                                        <button class="btn btn-info"><a href="{{route('product.status',$product->id)}}" style="color:white">Activate</a></button>
                                        @endif
